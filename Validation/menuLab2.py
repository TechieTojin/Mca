...
def main():
    while True:
        ...
        if choice == '1':
            ...
            s1 = set(int(x) for x in input("Enter elements of set 1 separated by space: ").split())
            s2 = set(int(x) for x in input("Enter elements of set 2 separated by space: ").split())
